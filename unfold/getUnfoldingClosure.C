...
int main(int argc, char *argv[]) {
  ...
  TFile *f0 = TFile::Open(Form("rawSpectra/RawSpectraMC_sample%d.root",kSample));
  //  TFile *f0 = TFile::Open(Form("rawSpectra/RawSpectraMC_sample%d_ptCut100Events.root",kSample));
  ...
  //  TFile *f2 = TFile::Open(Form("unfSpectra/rooUnfoldResponse_ReweightingMin0P4Max1P5_sample%d_ptCut100Events.root",kSample));
  ...
  RooUnfoldResponse* rooUnfoldRes_firstHalf[6][7]; // eta, cent
  TH2D* hDataReco[6][7]; 
  TH2D* hMcReco_secondHalf[6][7]; 
  TH2D* hDataUnf[6][7][10]; // unfolding iter
  TH2D* hMcUnf[6][7][10]; // unfolding iter
  TH2D *hMcTruth_secondHalf[6][7];
  std::string pdf_label;
  
   for (int etaBin = 0; etaBin < nEtaBins; ++etaBin) {
     for (int centBin = 0; centBin < nCentBins; ++centBin) {
       //       hMcReco_secondHalf[etaBin][centBin] = (TH2D*) f0->Get(Form("hCrossSecMc_m_pt_secondHalfReweightMin0P2Max2P0_eta%dcent%d",etaBin,centBin));
       hMcReco_secondHalf[etaBin][centBin] = (TH2D*) f0->Get(Form("hCrossSecMc_m_pt_secondHalfReweight_eta%dcent%d",etaBin,centBin));
       //       hMcTruth_secondHalf[etaBin][centBin] = (TH2D*) f0->Get(Form("hCrossSecMcTruth_secondHalfReweightMin0P2Max2P0_m_pt_eta%dcent%d",etaBin,centBin));
       hMcTruth_secondHalf[etaBin][centBin] = (TH2D*) f0->Get(Form("hCrossSecMcTruth_secondHalfReweight_m_pt_eta%dcent%d",etaBin,centBin));
       hDataReco[etaBin][centBin] = (TH2D*) f1->Get(Form("hCrossSecData_m_pt_eta%dcent%d",etaBin,centBin));
       rooUnfoldRes_firstHalf[etaBin][centBin] = (RooUnfoldResponse*) f2->Get(Form("responseMatrix_firstHalf_eta%d_cent%d",etaBin,centBin));

    }   
  }
   //   cout << " roounfold xbins " << rooUnfoldRes_firstHalf[5][0]->GetXaxis()->GetNbins() << " ybins " <<        rooUnfoldRes_firstHalf[5][0] << endl;
   cout << " mcReco xbins " << hMcReco_secondHalf[5][0]->GetXaxis()->GetNbins() << " ybins " <<        hMcReco_secondHalf[5][0]->GetYaxis()->GetNbins() << endl;
   cout << " dataReco xbins " << hDataReco[5][0]->GetXaxis()->GetNbins() << " ybins " <<        hDataReco[5][0]->GetYaxis()->GetNbins() << endl;
  ...
  for (int etaBin = 5; etaBin < nEtaBins; ++etaBin) {
	...
	cout << " rooUnfoldRes " << rooUnfoldRes_firstHalf[etaBin][centBin] << " hMcReco " << hMcReco_secondHalf[etaBin][centBin] << endl;
	RooUnfoldBayes unfoldMc (rooUnfoldRes_firstHalf[etaBin][centBin], hMcReco_secondHalf[etaBin][centBin], it);    
	...
	RooUnfoldBayes unfoldData (rooUnfoldRes_firstHalf[etaBin][centBin], hDataReco[etaBin][centBin], it);    
  ...
  for (int etaBin = 5; etaBin < nEtaBins; ++etaBin) {
	...
	hMcTruth_Pt[etaBin][centBin][mBin] = (TH1D*)hMcTruth_secondHalf[etaBin][centBin]->ProjectionX(Form("hMcTruthPt_eta%d_cent%d_m%d",etaBin,centBin,mBin),mBin+2,mBin+2);
	hMcReco_Pt[etaBin][centBin][mBin] = (TH1D*)hMcReco_secondHalf[etaBin][centBin]->ProjectionX(Form("hMcRecoPt_eta%d_cent%d_m%d",etaBin,centBin,mBin),mBin+2,mBin+2);	
	for ( int it = 0 ; it< nUnfIterations ; it++) {
  ...
  for (int etaBin = 5; etaBin < nEtaBins; ++etaBin) { 
	...
	hMcTruth_M[etaBin][centBin][ptBin] = (TH1D*)hMcTruth_secondHalf[etaBin][centBin]->ProjectionY(Form("hMcTruthM_eta%d_cent%d_pt%d",etaBin,centBin,ptBin),ptBin+2,ptBin+2);
	hMcReco_M[etaBin][centBin][ptBin] = (TH1D*)hMcReco_secondHalf[etaBin][centBin]->ProjectionY(Form("hMcRecoM_eta%d_cent%d_pt%d",etaBin,centBin,ptBin),ptBin+2,ptBin+2);	
	for ( int it = 0 ; it< nUnfIterations ; it++) {
  ...
  for (int in = 1; in < nUnfIterations ; in++)  {
    if ( in == 1 ) leg1->AddEntry(hMcUnf_M[5][0][0][in], Form("%dst iter.",in));
    else if ( in == 2 ) leg1->AddEntry(hMcUnf_M[5][0][0][in], Form("%dnd iter.",in));
    else if ( in == 3 ) leg1->AddEntry(hMcUnf_M[5][0][0][in], Form("%drd iter.",in));
    else  leg1->AddEntry(hMcUnf_M[5][0][0][in], Form("%dth iter.",in));
  }
  leg1->Draw();
  c1b->cd(5+1);
  leg1->Draw();
  ...
  for ( int ipt = 0 ; ipt < nPtBins-2; ipt++)  {
    ...
    drawBin(ptBins,ipt+3,"GeV",0.2, 0.3,1,18);
  ...
  pdf_label = "(";
  //  c1a->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_ReweightingMin0P4Max1P5.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcM_pt0-4"));
  c1a->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcM_pt0-4"));
  //  c1a->SaveAs(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_mcM_pt0-4_Reweighting.root",kSample,0,5));
  //    c1a->SaveAs(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_mcM_pt0-4_Reweighting.root",kSample,0,5));
  pdf_label = "";
  c1b->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcM_pt5-9"));
  //  c1b->SaveAs(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_mcM_pt5-9_Reweighting.root",kSample,0,5));
  //  c1b->SaveAs(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_mcM_pt5-9_Reweighting.root",kSample,0,5));
  c1c->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcM_pt10-14"));
  //  c1c->SaveAs(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_mcM_pt10-14_Reweighting.root",kSample,0,5));
  //c1c->SaveAs(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_mcM_pt10-14_Reweighting.root",kSample,0,5));
  c1d->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcM_pt15-19"));
  ...
  makeEfficiencyCanvas(c2,nPtBins-2+1, 0.02, 0.01, 0.2, 0.3, 0.01);
  ...
  for (int iter = 1; iter < nUnfIterations ; iter++)  {
    if ( iter == 1 ) leg2->AddEntry(hDataUnf_M[5][0][0][iter], Form("%dst iter.",iter));
    else if ( iter == 2 ) leg2->AddEntry(hDataUnf_M[5][0][0][iter], Form("%dnd iter.",iter));
    else if ( iter == 3 ) leg2->AddEntry(hDataUnf_M[5][0][0][iter], Form("%drd iter.",iter));
  ...
  c2a->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataM_pt0-4"));
  pdf_label = "";
  c2b->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataM_pt5-9"));
  c2c->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataM_pt10-14"));
  c2d->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataM_pt15-19"));  
  ...
  for (int in = 1; in < nUnfIterations ; in++)  {
    if ( in == 1 ) leg3->AddEntry(hMcUnf_M[5][0][0][in], Form("%dst iter.",in));
    else if ( in == 2 ) leg3->AddEntry(hMcUnf_M[5][0][0][in], Form("%dnd iter.",in));
    else if ( in == 3 ) leg3->AddEntry(hMcUnf_M[5][0][0][in], Form("%drd iter.",in));
  ...
  for ( int im = 0 ; im < nMBins-1 ; im++)  {
    ...
    drawBin(mBins,im+3,"GeV",0.2, 0.7,1,18);
  ...
  c3a->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcPt_m0-5"));
  pdf_label = "";
  c3b->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcPt_m6-11"));
  c3c->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcPt_m12-17"));
  c3d->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcPt_m18-23"));
  c3e->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:mcPt_m24-29"));  
  ...
  for (int iter = 1; iter < nUnfIterations ; iter++)  {
    if ( iter == 1 ) leg4->AddEntry(hDataUnf_Pt[5][0][0][iter], Form("%dst iter.",iter));
    else if ( iter == 2 ) leg4->AddEntry(hDataUnf_Pt[5][0][0][iter], Form("%dnd iter.",iter));
    else if ( iter == 3 ) leg4->AddEntry(hDataUnf_Pt[5][0][0][iter], Form("%drd iter.",iter));
  ...
  c4a->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataPt_m0-5"));
  pdf_label = "";
  c4b->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataPt_m6-11"));
  c4c->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataPt_m12-17"));
  c4d->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataPt_m18-23"));
  pdf_label = ")";
  c4e->Print(Form("Unfolding/Closure/Closure_sample%d_icent%d_etaBin%d_Reweighting.pdf%s",kSample,0,5, pdf_label.c_str()), Form("Title:dataPt_m24-29"));  

...
// Thu Feb  7 14:37:38 2019 by ROOT version 6.12/06
// from TTree tr/new tree
// found on file: ../ntuples/jetSubstructure_data_HION9_v51_r4_pbpb_apr24.root
//////////////////////////////////////////////////////////

#ifndef getEtaPhiLayers_h
#define getEtaPhiLayers_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         jets_fcal;
   std::vector<Float_t>  jets_samplingPerLayer;
   Float_t         trkJetMass4;
   Float_t         trkJetMass6;
   Float_t         trkJetMass8;
   ...
   getEtaPhiLayers(TTree *tree=0);
   virtual ~getEtaPhiLayers();
...
#ifdef getEtaPhiLayers_cxx
getEtaPhiLayers::getEtaPhiLayers(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ntuples/jetSubstructure_data_HION9_v51_r4_pbpb_apr24.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ntuples/jetSubstructure_data_HION9_v51_r4_pbpb_apr24.root");
      }
      f->GetObject("tr",tree);
...
getEtaPhiLayers::~getEtaPhiLayers()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t getEtaPhiLayers::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t getEtaPhiLayers::LoadTree(Long64_t entry)
{
...
void getEtaPhiLayers::Init(TTree *tree)
{
...
void getEtaPhiLayers::Show(Long64_t entry)
{
...
Int_t getEtaPhiLayers::Cut(Long64_t entry)
{
...
#endif // #ifdef getEtaPhiLayers_cxx

...
#ifndef getEtaPhiMap_MCpp_h
#define getEtaPhiMap_MCpp_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   getEtaPhiMap_MCpp(TTree *tree=0);
   virtual ~getEtaPhiMap_MCpp();
...
#ifdef getEtaPhiMap_MCpp_cxx
getEtaPhiMap_MCpp::getEtaPhiMap_MCpp(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
	...
	//         f = new TFile("../ntuples/jetSubstructure_data_HION9_v51_r4_pp_apr24.root");
	         f = new TFile("../ntuples/jetSubstructure_ppMCCombined_HION9_v60_april24.root");
      }
      f->GetObject("tr",tree);
...
getEtaPhiMap_MCpp::~getEtaPhiMap_MCpp()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t getEtaPhiMap_MCpp::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t getEtaPhiMap_MCpp::LoadTree(Long64_t entry)
{
...
void getEtaPhiMap_MCpp::Init(TTree *tree)
{
...
Bool_t getEtaPhiMap_MCpp::Notify()
{
...
void getEtaPhiMap_MCpp::Show(Long64_t entry)
{
...
Int_t getEtaPhiMap_MCpp::Cut(Long64_t entry)
{
...
#endif // #ifdef getEtaPhiMap_MCpp_cxx

...
void getMcWeights(int kSample = kPP, int icent=0, int etaBin=3, int nSys=-1, TList *listmcGlobal=0, TList *listmcGlobalTruth=0, TList *listmcGlobalCorr=0, TList *listmcGlobalTruthCorr=0, TList *listdataGlobal=0, TList *listm2ptGlobal=0, TList *listm2ptGlobalTruth=0, TList *listmcGlobal_jzNorm=0, TList *listmcGlobal_fcalWeight=0, TList *listmcGlobal_jetWeight=0, TList *listmcGlobal_noWeight=0) { 
...
void getDATAspectra(int kSample, int icent, int etaBin, TH2D* hdataRaw, /*TH2D* hdataRawGlobal,*/ int nSys) { 
  ...
  for (Int_t i= 0; i<entries ; i++) {
    ...
    if ( ! passEvent(tr.jets_cent, tr.jets_genPt, tr.jets_rawPt, icent, tr.jets_eta, tr.jets_phi, false) ) // isMC = false
      continue;
    if ( !passEtaCut(tr.jets_eta, etaBin) )
      continue;
...
int main (int argc, char *argv[]) {
  ...
  TList *listmcGlobal = new TList;
  TList *listmcGlobal_jzNorm = new TList;
  TList *listmcGlobal_fcalWeight = new TList;
  TList *listmcGlobal_jetWeight = new TList;
  TList *listmcGlobal_noWeight = new TList;
  TList *listmcGlobalTruth = new TList;
  TList *listmcGlobalCorr = new TList;
  TList *listmcGlobalTruthCorr = new TList;
  TList *listdataGlobal = new TList;
  TList *listm2ptGlobal = new TList;
  TList *listm2ptGlobalTruth = new TList;
  ...
  for (int etaBin = 0; etaBin<3; etaBin++){
    ...
    getMcWeights(kSample,icent,etaBin,nSys, listmcGlobal, listmcGlobalTruth, listmcGlobalCorr, listmcGlobalTruthCorr, listdataGlobal, listm2ptGlobal, listm2ptGlobalTruth, listmcGlobal_jzNorm, listmcGlobal_fcalWeight, listmcGlobal_jetWeight, listmcGlobal_noWeight);
  }
  hmcRawGlobal->Reset();
  hmcRawGlobal_jzNorm->Reset();
  hmcRawGlobal_fcalWeight->Reset();
  ...
  hmcGlobalTruthCorr->Reset();
  hdataRawGlobal->Reset();
  hm2ptRawGlobal->Reset();
  hm2ptRawGlobalTruth->Reset();
  
  delete listmcGlobal; delete listmcGlobalTruth; delete listmcGlobalCorr; delete listmcGlobalTruthCorr; delete listdataGlobal; delete listm2ptGlobal; delete listm2ptGlobalTruth; delete listmcGlobal_jzNorm; delete listmcGlobal_fcalWeight; delete listmcGlobal_jetWeight; delete listmcGlobal_noWeight;

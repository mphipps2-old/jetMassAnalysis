...
// Thu Feb  7 17:32:23 2019 by ROOT version 6.12/06
// from TTree tr/new tree
// found on file: ../ntuples/jetSubstructure_pbpbMC_HION9_jz2_v52_april24.root
//////////////////////////////////////////////////////////
...
#ifdef getJES_cxx
getJES::getJES(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ntuples/jetSubstructure_pbpbMC_HION9_jz2_v52_april24.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ntuples/jetSubstructure_pbpbMC_HION9_jz2_v52_april24.root");
      }
      f->GetObject("tr",tree);
...
Int_t getJES::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t getJES::LoadTree(Long64_t entry)
{
...
void getJES::Show(Long64_t entry)
{
...
Int_t getJES::Cut(Long64_t entry)
{

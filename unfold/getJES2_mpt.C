...
int main(int argc, char *argv[]) {
  ...
  getXbin(nPtBins, ptBins, 210);
  cout << " nPtBins = " << nPtBins << endl;
  // Ybin -> m2/pt2
  //  getYbin(nMBins, mBins, 772);
  getYbin(nMBins, mBins, 78);
  ...
  TH1D* hJMS_m_1d_pt1 = new TH1D("JMS_m_pt1","JMS_m_pt1",nMBins,mBins);
  TH1D* hJMR_m_1d_pt1 = new TH1D("JMR_m_pt1","JMR_m_pt1",nMBins,mBins);
  TH1D* hJMS_m_1d_pt2 = new TH1D("JMS_m_pt2","JMS_m_pt2",nMBins,mBins);
  TH1D* hJMR_m_1d_pt2 = new TH1D("JMR_m_pt2","JMR_m_pt2",nMBins,mBins);
  TH1D* hJMS_m_1d_pt3 = new TH1D("JMS_m_pt3","JMS_m_pt3",nMBins,mBins);
  TH1D* hJMR_m_1d_pt3 = new TH1D("JMR_m_pt3","JMR_m_pt3",nMBins,mBins);
  TH1D* hJMS_m_1d_pt4 = new TH1D("JMS_m_pt4","JMS_m_pt4",nMBins,mBins);
  TH1D* hJMR_m_1d_pt4 = new TH1D("JMR_m_pt4","JMR_m_pt4",nMBins,mBins);
  TH1D* hJMS_m_1d_pt5 = new TH1D("JMS_m_pt5","JMS_m_pt5",nMBins,mBins);
  TH1D* hJMR_m_1d_pt5 = new TH1D("JMR_m_pt5","JMR_m_pt5",nMBins,mBins);
  TH1D* hJMS_m_1d_pt6 = new TH1D("JMS_m_pt6","JMS_m_pt6",nMBins,mBins);
  TH1D* hJMR_m_1d_pt6 = new TH1D("JMR_m_pt6","JMR_m_pt6",nMBins,mBins);
  TH1D* hJMS_m_1d_pt7 = new TH1D("JMS_m_pt7","JMS_m_pt7",nMBins,mBins);
  TH1D* hJMR_m_1d_pt7 = new TH1D("JMR_m_pt7","JMR_m_pt7",nMBins,mBins);
  TH1D* hJMS_m_1d_pt8 = new TH1D("JMS_m_pt8","JMS_m_pt8",nMBins,mBins);
  TH1D* hJMR_m_1d_pt8 = new TH1D("JMR_m_pt8","JMR_m_pt8",nMBins,mBins);
  TH1D* hJMS_m_1d_pt9 = new TH1D("JMS_m_pt9","JMS_m_pt9",nMBins,mBins);
  TH1D* hJMR_m_1d_pt9 = new TH1D("JMR_m_pt9","JMR_m_pt9",nMBins,mBins);
  TH1D* hJMS_m_1d_pt10 = new TH1D("JMS_m_pt10","JMS_m_pt10",nMBins,mBins);
  TH1D* hJMR_m_1d_pt10 = new TH1D("JMR_m_pt10","JMR_m_pt10",nMBins,mBins);
  ...
  TH1D* hDist2_m_pt1[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt2[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt3[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt4[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt5[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt6[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt7[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt8[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt9[32]; // reco_m/pt - gen_m/pT
  TH1D* hDist2_m_pt10[32]; // reco_m/pt - gen_m/pT
  ...
  for (int mBin = 0; mBin <= nMBins+1; ++mBin) {
    ...
    hDist_m[mBin] = new TH1D(name,name, 100,0,5);
    sprintf(name, "hDistm_m%d",mBin);
    hDistJes_m[mBin] = new TH1D(name,name, 50,0.7,2);
    
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt1",mBin);
    hDist2_m_pt1[mBin] = new TH1D(name,name, 500,-0.2,0.2);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt2",mBin);
    hDist2_m_pt2[mBin] = new TH1D(name,name, 100,-1,1);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt3",mBin);
    hDist2_m_pt3[mBin] = new TH1D(name,name, 500,-0.2,0.2);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt4",mBin);
    hDist2_m_pt4[mBin] = new TH1D(name,name, 100,-1,1);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt5",mBin);
    hDist2_m_pt5[mBin] = new TH1D(name,name, 100,-1,1);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt6",mBin);
    hDist2_m_pt6[mBin] = new TH1D(name,name, 100,-1,1);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt7",mBin);
    hDist2_m_pt7[mBin] = new TH1D(name,name, 500,-0.2,0.2);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt8",mBin);
    hDist2_m_pt8[mBin] = new TH1D(name,name, 100,-1,1);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt9",mBin);
    hDist2_m_pt9[mBin] = new TH1D(name,name, 100,-1,1);
    sprintf(name, "hDistM2Pt2_reco-truth_m%d_pt10",mBin);
    hDist2_m_pt10[mBin] = new TH1D(name,name, 100,-1,1);
  }
  ...
  for ( int ijz =2 ; ijz<=4 ; ijz++) {
	...
	fcalWeight = hFcalReweight->GetBinContent(hFcalReweight->GetXaxis()->FindBin(tr.jets_fcal));
      ...
      int mBin = mBinTemp->FindBin((tr.jets_genMass)/(tr.jets_genPt));

      //      cout << " ptBin " << ptBin << " pt " << tr.jets_ptCalib << endl;
      if (eta < 2.1 && kSample == kPP) {
	hDist_eta[5]->Fill ((tr.jets_massCalib/(tr.jets_ptCalib)) / (tr.jets_genMass / (tr.jets_genPt)), tr.jets_weight * jzNorm * fcalWeight );
      	hDistJes_eta[5]->Fill( tr.jets_ptCalib / tr.jets_genPt , tr.jets_weight * jzNorm * fcalWeight );

	hDist[5][ptBin][mBin]->Fill ((tr.jets_massCalib/(tr.jets_ptCalib)) / (  tr.jets_genMass / (tr.jets_genPt ) ) , tr.jets_weight * jzNorm * fcalWeight );
	hDistJes[5][ptBin][mBin]->Fill( tr.jets_ptCalib / tr.jets_genPt, tr.jets_weight * jzNorm * fcalWeight );
      }
      hDist_eta[etaBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) / (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight );      
      ...
      hDist_pt[ptBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) / (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );      
	    //      hDistJes_pt[ptBin]->Fill( tr.jets_ptCalib / tr.jets_genPt  , tr.jets_weight * jzNorm * fcalWeight );
            hDistJes_pt[ptBin]->Fill( tr.jets_ptCalib / tr.jets_genPt );
      ...
      hDist_m[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) / (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      //      hDistJes_m[mBin]->Fill( tr.jets_ptCalib / tr.jets_genPt, tr.jets_weight * jzNorm * fcalWeight  );
      hDistJes_m[mBin]->Fill( tr.jets_ptCalib / tr.jets_genPt, tr.jets_weight * jzNorm * fcalWeight );      
      
      hDist[etaBin][ptBin][mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) / (  tr.jets_genMass / ( tr.jets_genPt) ) , tr.jets_weight * jzNorm * fcalWeight );      
      hDistJes[etaBin][ptBin][mBin]->Fill( tr.jets_ptCalib / tr.jets_genPt , tr.jets_weight * jzNorm * fcalWeight );


      if (ptBin == 1 || ptBin == 2) hDist2_m_pt1[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 3 || ptBin == 4) hDist2_m_pt2[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 5 || ptBin == 6) hDist2_m_pt3[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 7 || ptBin == 8) hDist2_m_pt4[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 9 || ptBin == 10) hDist2_m_pt5[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 11 || ptBin == 12) hDist2_m_pt6[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 13 || ptBin == 14) hDist2_m_pt7[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 15 || ptBin == 16) hDist2_m_pt8[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 17 || ptBin == 18) hDist2_m_pt9[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
      else if (ptBin == 19 || ptBin == 20) hDist2_m_pt10[mBin]->Fill((tr.jets_massCalib/(tr.jets_ptCalib)) - (  tr.jets_genMass / (tr.jets_genPt) ), tr.jets_weight * jzNorm * fcalWeight  );
    ...
    //TFile* foutJES = new TFile(Form("Plots/JES_mpt/jes_kSample%d.root",kSample),"recreate");
  gStyle->SetOptStat(1);
  ...
  for ( int etaBin = 0; etaBin < nEtaBins; ++etaBin ) {    
    ...
    hDist_eta[etaBin]->Fit("gaus", "","",theMean - 1*theRms, theMean + .8*theRms);
    ...
    hDistJes_eta[etaBin]->Fit("gaus", "","",theMeanJes - 1*theRmsJes, theMeanJes + .8*theRmsJes);
  ...
  sprintf(fileName,"Plots/JES_mpt/JMSFit_eta_sample%d.png",kSample);
  c0->SaveAs(fileName);

  sprintf(fileName,"Plots/JES_mpt/JESFit_eta_sample_%d.png",kSample);
  c_b->SaveAs(fileName);
  delete c0;
  delete c_b;
  ...
  for ( int ptBin = 0; ptBin < nPtBins; ++ptBin ) {    
    ...
    hDist_pt[ptBin]->Fit("gaus", "","",theMean - 1*theRms, theMean + .3*theRms);
    ...
    hDistJes_pt[ptBin]->Fit("gaus", "","",theMeanJes - 1*theRmsJes, theMeanJes + .8*theRmsJes);
  ...
  sprintf(fileName,"Plots/JES_mpt/JMSFit_pt_sample%d.png",kSample);
  c1->SaveAs(fileName);
  sprintf(fileName,"Plots/JES_mpt/JESFit_pt_sample_%d.png",kSample);
  c1b->SaveAs(fileName);
  ...
  c2c = new TCanvas("c2c","c2c",500,500);
  c2c->Divide(4,2);

  c2d = new TCanvas("c2d","c2d",500,500);
  c2d->Divide(4,2);

  c2e = new TCanvas("c2e","c2e",500,500);
  c2e->Divide(4,2);        
  for ( int mBin = 0; mBin < nMBins; ++mBin ) {    
    ...
    hDist_m[mBin]->Fit("gaus", "","",theMean - 1*theRms, theMean + .8*theRms);
    ...
    c2b->cd(mBin+1); 
    double theMeanJes = hDistJes_m[mBin]->GetBinCenter( hDistJes_m[mBin]->GetMaximumBin() );
    double theRmsJes = hDistJes_m[mBin]->GetRMS();
    if (mBin > 0)    hDistJes_m[mBin]->Fit("gaus", "","",1 - 0.8*theRmsJes, 1 + 0.8*theRmsJes);
    else hDistJes_m[mBin]->Fit("gaus", "","",1.3 - 0.8*theRmsJes, 1.3 + 0.8*theRmsJes);
    ...
    c2c->cd(mBin+1);    c2c->cd(mBin+1);
    theMean = hDist2_m_pt1[mBin]->GetBinCenter( hDist2_m_pt1[mBin]->GetMaximumBin() );
    theRms = hDist2_m_pt1[mBin]->GetRMS();
    hDist2_m_pt1[mBin]->Fit("gaus", "","",theMean - 1*theRms, theMean + .8*theRms);
    if ( hDist2_m_pt1[mBin]->GetFunction("gaus") == NULL ) {
      hJMS_m_1d_pt1->SetBinContent(mBin+1,-100);
      hJMS_m_1d_pt1->SetBinError(mBin+1,-100);
      hJMR_m_1d_pt1->SetBinContent(mBin+1,-100);
      hJMR_m_1d_pt1->SetBinError(mBin+1,-100);
    }
    else {
      float theJMS = hDist2_m_pt1[mBin]->GetFunction("gaus")->GetParameter(1);
      float theJMSerr = hDist2_m_pt1[mBin]->GetFunction("gaus")->GetParError(1);
      float theJMR = hDist2_m_pt1[mBin]->GetFunction("gaus")->GetParameter(2);
      float theJMRerr = hDist2_m_pt1[mBin]->GetFunction("gaus")->GetParError(2);
      hJMS_m_1d_pt1->SetBinContent(mBin+1,theJMS);
      hJMS_m_1d_pt1->SetBinError(mBin+1,theJMSerr);
      hJMR_m_1d_pt1->SetBinContent(mBin+1,theJMR);
      hJMR_m_1d_pt1->SetBinError(mBin+1,theJMRerr);
    }
    handsomeTH1(hDist2_m_pt1[mBin],1);
    //    fixedFontHist(hDist_m[mBin],2.5,2,20);
    hDist2_m_pt1[mBin]->Draw();
    hDist2_m_pt1[mBin]->GetXaxis()->SetTitle("(m/#it{p}_{T})^{reco} - (m/#it{p}_{T})^{truth}");
    if (mBin == 0) {
      drawCentrality(kSample,-1,0.70,0.86,1,24);
      ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    }
    ...
    c2d->cd(mBin+1);
    theMean = hDist2_m_pt3[mBin]->GetBinCenter( hDist2_m_pt3[mBin]->GetMaximumBin() );
    theRms = hDist2_m_pt3[mBin]->GetRMS();
    hDist2_m_pt3[mBin]->Fit("gaus", "","",theMean - 1*theRms, theMean + .8*theRms);
    if ( hDist2_m_pt3[mBin]->GetFunction("gaus") == NULL ) {
      hJMS_m_1d_pt3->SetBinContent(mBin+1,-100);
      hJMS_m_1d_pt3->SetBinError(mBin+1,-100);
      hJMR_m_1d_pt3->SetBinContent(mBin+1,-100);
      hJMR_m_1d_pt3->SetBinError(mBin+1,-100);
    }
    else {
      float theJMS = hDist2_m_pt3[mBin]->GetFunction("gaus")->GetParameter(1);
      float theJMSerr = hDist2_m_pt3[mBin]->GetFunction("gaus")->GetParError(1);
      float theJMR = hDist2_m_pt3[mBin]->GetFunction("gaus")->GetParameter(2);
      float theJMRerr = hDist2_m_pt3[mBin]->GetFunction("gaus")->GetParError(2);
      hJMS_m_1d_pt3->SetBinContent(mBin+1,theJMS);
      hJMS_m_1d_pt3->SetBinError(mBin+1,theJMSerr);
      hJMR_m_1d_pt3->SetBinContent(mBin+1,theJMR);
      hJMR_m_1d_pt3->SetBinError(mBin+1,theJMRerr);
    }
    handsomeTH1(hDist2_m_pt3[mBin],1);    
    hDist2_m_pt3[mBin]->Draw();
    hDist2_m_pt3[mBin]->GetXaxis()->SetTitle("(m/#it{p}_{T})^{reco} - (m/#it{p}_{T})^{truth}");
    if (mBin == 0) {
      drawCentrality(kSample,-1,0.70,0.86,1,24);
      ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    }
    ...
    c2e->cd(mBin+1);
    theMean = hDist2_m_pt7[mBin]->GetBinCenter( hDist2_m_pt7[mBin]->GetMaximumBin() );
    theRms = hDist2_m_pt7[mBin]->GetRMS();
    hDist2_m_pt7[mBin]->Fit("gaus", "","",theMean - 1*theRms, theMean + .8*theRms);
    if ( hDist2_m_pt7[mBin]->GetFunction("gaus") == NULL ) {
      hJMS_m_1d_pt7->SetBinContent(mBin+1,-100);
      hJMS_m_1d_pt7->SetBinError(mBin+1,-100);
      hJMR_m_1d_pt7->SetBinContent(mBin+1,-100);
      hJMR_m_1d_pt7->SetBinError(mBin+1,-100);
    }
    else {
      float theJMS = hDist2_m_pt7[mBin]->GetFunction("gaus")->GetParameter(1);
      float theJMSerr = hDist2_m_pt7[mBin]->GetFunction("gaus")->GetParError(1);
      float theJMR = hDist2_m_pt7[mBin]->GetFunction("gaus")->GetParameter(2);
      float theJMRerr = hDist2_m_pt7[mBin]->GetFunction("gaus")->GetParError(2);
      hJMS_m_1d_pt7->SetBinContent(mBin+1,theJMS);
      hJMS_m_1d_pt7->SetBinError(mBin+1,theJMSerr);
      hJMR_m_1d_pt7->SetBinContent(mBin+1,theJMR);
      hJMR_m_1d_pt7->SetBinError(mBin+1,theJMRerr);
    }
    handsomeTH1(hDist2_m_pt7[mBin],1);    
    hDist2_m_pt7[mBin]->Draw();
    hDist2_m_pt7[mBin]->GetXaxis()->SetTitle("(m/#it{p}_{T})^{reco} - (m/#it{p}_{T})^{truth}");
    if (mBin == 0) {
      drawCentrality(kSample,-1,0.70,0.86,1,24);
      ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    }
  ...
  sprintf(fileName,"Plots/JES_mpt/JMSFit_m_sample%d.png",kSample);
  c2->SaveAs(fileName);
  sprintf(fileName,"Plots/JES_mpt/JESFit_m_sample_%d.png",kSample);
  c2b->SaveAs(fileName);
  sprintf(fileName,"Plots/JES_mpt/JMSFit_m_sample_%d_pt1.png",kSample);
  c2c->SaveAs(fileName);
  sprintf(fileName,"Plots/JES_mpt/JMSFit_m_sample_%d_pt2.png",kSample);
  c2d->SaveAs(fileName);
  sprintf(fileName,"Plots/JES_mpt/JMSFit_m_sample_%d_pt3.png",kSample);
  c2e->SaveAs(fileName);
  
  delete c2; delete c2b; delete c2c; delete c2d; delete c2e;
  
  TCanvas *c100;
  TCanvas *c100b;
  c100 = new TCanvas("c100","c100");
  c100->Divide(3,2);
  c100b = new TCanvas("c100b","c100b");
  c100b->Divide(3,2);  
 ...
 for ( int etaBin = 0; etaBin < nEtaBins; ++etaBin ) {
   // for ( int etaBin = 5; etaBin < nEtaBins; ++etaBin ) {    
	...
	if (mBin == 0 && etaBin == 5) c100->cd(ptBin+1);
	...
	hDistJes[etaBin][ptBin][mBin]->Fit("gaus", "","",theMeanJes - 1*theRmsJes, theMeanJes + 1*theRmsJes);
	if ( hDistJes[etaBin][ptBin][mBin]->GetFunction("gaus") == NULL ) {
	  ...
	  if (mBin == 0 && etaBin == 5) {
	    ...
	    cout << " ptBin " << ptBin << " mBin " << mBin << " JES " << theJES << endl;
	  }
  ...
  sprintf(fileName,"Plots/JES_mpt/JESFit_mpt2dFits_sample%d.png",kSample);
  c100->SaveAs(fileName);
  ...
  leg1->Draw();
  sprintf(fileName,"Plots/JES_mpt/JMS_eta_sample%d.png",kSample);
  c4->SaveAs(fileName);
  delete c4;
  ...
  leg2->Draw();
  sprintf(fileName,"Plots/JES_mpt/JES_eta_sample%d.png",kSample);
  c5->SaveAs(fileName);
  delete c5;
  ...
  leg6->Draw();
  sprintf(fileName,"Plots/JES_mpt/JMS_pt_sample%d.png",kSample);
  c6->SaveAs(fileName);
  delete c6;
  ...
  leg3->Draw();
  sprintf(fileName,"Plots/JES_mpt/JES_pt_sample%d.png",kSample);
  c7->SaveAs(fileName);
  delete c7;
  ...
  hJMS_m_1d->GetXaxis()->SetTitle("Truth m/#it{p}_{T}");
  hJMS_m_1d->Draw();
  hJMS_m_1d->GetYaxis()->SetRangeUser(0,3.5);
  hJMR_m_1d->Draw("same");
  hJMR_m_1d->GetYaxis()->SetRangeUser(0,3.5);
  drawCentrality(kSample,-1,0.70,0.86,1,24);
  ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
  ...
  leg4->Draw();
  sprintf(fileName,"Plots/JES_mpt/JMS_m_sample%d.png",kSample);
  c8->SaveAs(fileName);
  delete c8;
  ...
  hJES_m_1d->GetXaxis()->SetTitle("Truth m/#it{p}_{T}");
  hJES_m_1d->Draw();
  ...
  easyLeg(leg5,"");
  leg5->AddEntry(hJES_m_1d, "JES","plfe");
  leg5->AddEntry(hJER_m_1d, "JER","plfe");
  leg5->Draw();
  sprintf(fileName,"Plots/JES_mpt/JES_m_sample%d.png",kSample);
  c9->SaveAs(fileName);
  delete c9;


  TCanvas *c20 = new TCanvas("c20","",500,500);
  handsomeTH1(hJMS_m_1d_pt1,1);
  handsomeTH1(hJMS_m_1d_pt3,2);
  handsomeTH1(hJMS_m_1d_pt7,4);
  
  //  fixedFontHist(hJMS_m_1d,2.5,2,20);
  // fixedFontHist(hJER_m_1d,2.5,2,20);
  hJMS_m_1d_pt1->GetXaxis()->SetTitle("Truth m/#it{p}_{T}");
  hJMS_m_1d_pt1->GetYaxis()->SetTitle("[m/#it{p}_{T}]^{Reco} - [m/#it{p}_{T}]^{Truth}");
  hJMS_m_1d_pt1->Draw();
  hJMS_m_1d_pt1->GetYaxis()->SetRangeUser(-0.05,0.12);
  hJMS_m_1d_pt3->SetMarkerStyle(25);
  hJMS_m_1d_pt3->Draw("same");
  hJMS_m_1d_pt7->SetMarkerStyle(28);
  hJMS_m_1d_pt7->Draw("same");

  drawCentrality(kSample,-1,0.70,0.86,1,24);
  ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
  TLegend *leg20 = new TLegend(0.3471854,0.6394175,0.8549639,0.8233743,NULL,"brNDC");
  
  easyLeg(leg20,"");
  leg20->AddEntry(hJMS_m_1d_pt1, "100 #leq Truth Jet #it{p}_{T} < 126 GeV","plfe");
  leg20->AddEntry(hJMS_m_1d_pt3, "158 #leq Truth Jet #it{p}_{T} < 200 GeV","plfe");
  leg20->AddEntry(hJMS_m_1d_pt7, "398 #leq Truth Jet #it{p}_{T} < 501 GeV","plfe");

  
  leg20->Draw();
  sprintf(fileName,"Plots/JES_mpt/JMS_m_sample%d_pt.png",kSample);
  c20->SaveAs(fileName);
  delete c20;

  TCanvas *c21 = new TCanvas("c21","",500,500);
  handsomeTH1(hJMR_m_1d_pt1,1);
  handsomeTH1(hJMR_m_1d_pt3,2);
  handsomeTH1(hJMR_m_1d_pt7,4);

  
  //  fixedFontHist(hJMR_m_1d,2.5,2,21);
  // fixedFontHist(hJER_m_1d,2.5,2,21);
  hJMR_m_1d_pt1->GetXaxis()->SetTitle("Truth m/#it{p}_{T}");
  hJMR_m_1d_pt1->GetYaxis()->SetTitle("JMR");
  hJMR_m_1d_pt1->Draw();
  hJMR_m_1d_pt1->GetYaxis()->SetRangeUser(0,0.1);
  hJMR_m_1d_pt3->SetMarkerStyle(25);
  hJMR_m_1d_pt3->Draw("same");
  hJMR_m_1d_pt7->SetMarkerStyle(28);
  hJMR_m_1d_pt7->Draw("same");

  drawCentrality(kSample,-1,0.70,0.86,1,24);
  ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
  TLegend *leg21 = new TLegend(0.3471854,0.6394175,0.8549639,0.8233743,NULL,"brNDC");
  
  easyLeg(leg21,"");
  leg21->AddEntry(hJMR_m_1d_pt1, "100 #leq Truth Jet #it{p}_{T} < 126 GeV","plfe");
  leg21->AddEntry(hJMR_m_1d_pt3, "158 #leq Truth Jet #it{p}_{T} < 210 GeV","plfe"); 
  leg21->AddEntry(hJMR_m_1d_pt7, "398 #leq Truth Jet #it{p}_{T} < 501 GeV","plfe");
  leg21->Draw();
  sprintf(fileName,"Plots/JES_mpt/JMR_m_sample%d_pt.png",kSample);
  c21->SaveAs(fileName);
  delete c21;
  ...
  for (int etaBin = 0; etaBin < nEtaBins; ++etaBin) {
    ...
    hJMS[etaBin]->GetYaxis()->SetTitle("Truth m/#it{p}_{T}");
    ...
    drawCentrality(kSample,-1,0.70,0.86,1,24);
    ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    sprintf(fileName,"Plots/JES_mpt/JMS_MvsPt_eta%d_sample%d.png",etaBin,kSample);
    c10->SaveAs(fileName);
    delete c10;
    ...
    hJMR[etaBin]->GetYaxis()->SetTitle("Truth m/#it{p}_{T}");
    hJMR[etaBin]->Draw("colz");
    hJMR[etaBin]->SetContour(99);
    hJMR[etaBin]->SetMaximum(0.6);
    hJMR[etaBin]->SetMinimum(0.);
    c11->SetLogx();
    drawCentrality(kSample,-1,0.70,0.86,1,24);
    ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    sprintf(fileName,"Plots/JES_mpt/JMR_MvsPt_etaBin%d_sample%d.png",etaBin,kSample);
    c11->SaveAs(fileName);
    delete c11;
    ...
    hJES[etaBin]->GetYaxis()->SetTitle("Truth m/#it{p}_{T}");
    hJES[etaBin]->Draw("colz");
    hJES[etaBin]->SetContour(99);
    hJES[etaBin]->SetMaximum(1.3);
    hJES[etaBin]->SetMinimum(0.7);
    drawCentrality(kSample,-1,0.70,0.86,1,24);
    c12->SetLogx();
    ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    sprintf(fileName,"Plots/JES_mpt/JES_MvsPt_etaBin%d_sample%d.png",etaBin,kSample);
    c12->SaveAs(fileName);
    delete c12;
    ...
    hJER[etaBin]->GetYaxis()->SetTitle("Truth m/#it{p}_{T}");
    hJER[etaBin]->Draw("colz");
    hJER[etaBin]->SetMaximum(0.3);
    hJER[etaBin]->SetMinimum(0.0);
    hJER[etaBin]->SetContour(99);
    c13->SetLogx();
    drawCentrality(kSample,-1,0.70,0.86,1,24);
    ATLASLabel(0.25, 0.92, "Internal",0.085,0.28);//, "Pb+Pb  #sqrt{#font[12]{s_{NN}}} = 5.02 TeV, 0.49 nb^{-1}", kBlack);
    sprintf(fileName,"Plots/JES_mpt/JER_MvsPt_etaBin%d_sample%d.png",etaBin,kSample);
    c13->SaveAs(fileName);
    delete c13;
  }
  return 0;

...
#ifndef getEtaPhiMap_h
#define getEtaPhiMap_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   getEtaPhiMap(TTree *tree=0);
   virtual ~getEtaPhiMap();
...
#ifdef getEtaPhiMap_cxx
getEtaPhiMap::getEtaPhiMap(TTree *tree) : fChain(0) 
{
...
getEtaPhiMap::~getEtaPhiMap()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t getEtaPhiMap::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t getEtaPhiMap::LoadTree(Long64_t entry)
{
...
void getEtaPhiMap::Init(TTree *tree)
{
...
void getEtaPhiMap::Show(Long64_t entry)
{
...
Int_t getEtaPhiMap::Cut(Long64_t entry)
{

...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   sprintf(name,"calibration/etaPhiAvgPtcent0_pbpb.png");
   c1->SaveAs(name);
   sprintf(name,"calibration/etaPhiAvgPtcent0_pbpb.root");
   c1->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStatscent0_pbpb.png");
   c2->SaveAs(name);
   sprintf(name,"calibration/etaPhiStatscent0_pbpb.root");
   c2->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStatscent1_pbpb.png");
   c3->SaveAs(name);
   sprintf(name,"calibration/etaPhiStatscent1_pbpb.root");
   c3->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStatscent2_pbpb.png");
   c4->SaveAs(name);
   sprintf(name,"calibration/etaPhiStatscent2_pbpb.root");
   c4->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStatscent3_pbpb.png");
   c5->SaveAs(name);
   sprintf(name,"calibration/etaPhiStatscent3_pbpb.root");
   c5->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStatscent4_pbpb.png");
   c2->SaveAs(name);
   sprintf(name,"calibration/etaPhiStatscent4_pbpb.root");
   c2->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStatscent5_pbpb.png");
   c7->SaveAs(name);
   sprintf(name,"calibration/etaPhiStatscent5_pbpb.root");
   c7->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiAvgPt_cent6_pbpb.png");
   c8->SaveAs(name);
   sprintf(name,"calibration/etaPhiAvgPt_cent6_pbpb.root");
   c8->SaveAs(name);

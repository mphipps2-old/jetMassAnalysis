#define getEtaPhiMap_MCpp_cxx
#include "getEtaPhiMap_MCpp.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void getEtaPhiMap_MCpp::Loop()
{
//   In a ROOT session, you can do:
//      root> .L getEtaPhiMap_MCpp.C
//      root> getEtaPhiMap_MCpp t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH2F* etaPhiStats;
   char name[256];
   sprintf(name,"etaPhiAvgPt_MCpp");
   etaPhiAvgPt = new TH2F(name,name, 56,-2.1,2.1, 62,-3.14,3.14);
   sprintf(name,"etaPhiStats_MCpp");
   ...
   sprintf(name,"calibration/etaPhiAvgPt_MCpp.png");
   c1->SaveAs(name);
   sprintf(name,"calibration/etaPhiAvgPt_MCpp.root");
   c1->SaveAs(name);
   ...
   sprintf(name,"calibration/etaPhiStats_MCpp.png");
   c2->SaveAs(name);
   sprintf(name,"calibration/etaPhiStats_MCpp.root");
   c2->SaveAs(name);
   delete c1; delete c2;
}

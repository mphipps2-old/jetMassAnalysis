...
// Thu Jan  3 17:05:10 2019 by ROOT version 6.12/06
// from TTree tr/new tree
// found on file: ../ntuples/jetSubstructure_data_HION9_v51_r4_pp_apr24.root
//////////////////////////////////////////////////////////

#ifndef getEtaPhiMap_MCpbpb_h
#define getEtaPhiMap_MCpbpb_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   getEtaPhiMap_MCpbpb(TTree *tree=0);
   virtual ~getEtaPhiMap_MCpbpb();
...
#ifdef getEtaPhiMap_MCpbpb_cxx
getEtaPhiMap_MCpbpb::getEtaPhiMap_MCpbpb(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
	...
	//         f = new TFile("../ntuples/jetSubstructure_data_HION9_v51_r4_pp_apr24.root");
	         f = new TFile("../ntuples/jetSubstructure_pbpbMCCombined_HION9_v52_april24.root");
      }
      f->GetObject("tr",tree);
...
getEtaPhiMap_MCpbpb::~getEtaPhiMap_MCpbpb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t getEtaPhiMap_MCpbpb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t getEtaPhiMap_MCpbpb::LoadTree(Long64_t entry)
{
...
void getEtaPhiMap_MCpbpb::Init(TTree *tree)
{
...
Bool_t getEtaPhiMap_MCpbpb::Notify()
{
...
void getEtaPhiMap_MCpbpb::Show(Long64_t entry)
{
...
Int_t getEtaPhiMap_MCpbpb::Cut(Long64_t entry)
{
...
#endif // #ifdef getEtaPhiMap_MCpbpb_cxx

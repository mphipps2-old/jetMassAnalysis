...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH2F *h2_jetMass2Pt = new TH2F("jetMass2Pt","jetMass2Pt",125,100,700,125,-100,300);
   TH2F *h2_jetMass2OverPt2VsPt2 = new TH2F("jetMass2OverPt2VsPt2","jetMass2Pt2",125,10000,500000,125,-.005,.1);
   TH2F *h2_jetMass2OverPt2VsPt = new TH2F("jetMass2OverPt2VsPt","jetMass2OverPt2VsPt",125,100,700,125,-.005,.01);

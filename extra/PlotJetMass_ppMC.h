...
// Mon Feb 11 13:22:25 2019 by ROOT version 6.12/06
// from TTree tr/new tree
// found on file: jetSubstructure_data_HION9_v51_r4_pp_apr24.root
//////////////////////////////////////////////////////////

#ifndef PlotJetMass_ppMC_h
#define PlotJetMass_ppMC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   PlotJetMass_ppMC(TTree *tree=0);
   virtual ~PlotJetMass_ppMC();
...
#ifdef PlotJetMass_ppMC_cxx
PlotJetMass_ppMC::PlotJetMass_ppMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("jetSubstructure_data_HION9_v51_r4_pp_apr24.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("jetSubstructure_data_HION9_v51_r4_pp_apr24.root");
      }
      f->GetObject("tr",tree);
...
PlotJetMass_ppMC::~PlotJetMass_ppMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PlotJetMass_ppMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PlotJetMass_ppMC::LoadTree(Long64_t entry)
{
...
void PlotJetMass_ppMC::Init(TTree *tree)
{
...
Bool_t PlotJetMass_ppMC::Notify()
{
...
void PlotJetMass_ppMC::Show(Long64_t entry)
{
...
Int_t PlotJetMass_ppMC::Cut(Long64_t entry)
{
...
#endif // #ifdef PlotJetMass_ppMC_cxx
